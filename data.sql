...
INSERT INTO animals (name, date_of_birth, escape_attempts, neutered, weight_kg) VALUES ('Luna', '20-04-202', 0, TRUE, 9.5);
INSERT INTO animals (name, date_of_birth, escape_attempts, neutered, weight_kg) VALUES ('Daisy', '25-12-2028', 1, TRUE, 12.8);
INSERT INTO animals (name, date_of_birth, escape_attempts, neutered, weight_kg) VALUES ('Charlie', '17-02-2022', 0, FALSE, 6.5);
...
INSERT INTO specializations (species_id, vet_id) 
VALUES (1,(SELECT id FROM vets WHERE name = 'Stephanie Mendez')), (2,(SELECT id FROM vets WHERE name = 'Stephanie Mendez'));
